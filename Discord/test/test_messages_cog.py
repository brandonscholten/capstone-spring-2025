...
async def test_create_game():
    ...
    sentMsg = await dpytest.message("!create_game")

    await dpytest.message("Hello!")

    #print(f'Message ID: {sentMsg.id}')
...
class Messages(commands.Cog):
    ...
    async def createGame(self, interaction: discord.Interaction, game_name: typing.Optional[str], game_max_players: typing.Optional[int], game_date: typing.Optional[str], game_time: typing.Optional[str]):
        ...
        print("out of the date while loop")
        ...
        # Make an auto yes if 10 or larger, will prompt if a full or half room is wanted
        #
        if game_max_players >= 10:
            print("In max player check IF!")
            ...
            print("In max player check ELSE!")
            ...
            print(f'Private Room wanted?: {privateRoomWanted}')
        ...
        if privateRoomWanted:
         ...
         try:
            ...
            if denyMessageReason != None:
                ...
                DMDiscordServerMember(self.bot, usersID, denialMessage)
...
async def DMDiscordServerMember(bot, discordUserID, message):
    userObject = await bot.find_user(discordUserID)
    userObject.send(message)
